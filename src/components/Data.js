        ...
        {itemData.map((item,index)=>(
            ...
            <Card.Body>
              ...
              <div className="button ">
                <Button id="button2" variant="primary">Add to cart</Button>

                <Button id="button2" variant="primary">git 10% discount </Button>
              </div>
            </Card.Body>
...
return(
    <>
     <Button id="button" variant="primary" onClick={() => handleFilterClick("All")}>
        All
      </Button>
      <Button id="button" variant="primary" onClick={() => handleFilterClick("men's clothing")}>
        Men's Clothing
      </Button>
      <Button id="button" variant="primary" onClick={() => handleFilterClick("jewelery")}>
        Jewelery
      </Button>
      <Button id="button" variant="primary" onClick={() => handleFilterClick("electronics")}>
        Electronics
      </Button>
